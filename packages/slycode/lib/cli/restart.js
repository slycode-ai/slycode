    ...
    if (runMode === 'launchd') {
        for (const svc of servicesToRestart) {
            ...
            try {
                ...
                try {
                    (0, child_process_1.execSync)(`launchctl unload "${plistFile}"`, { stdio: 'pipe', timeout: 10000, windowsHide: true });
                }
                catch { /* may not be loaded */ }
                (0, child_process_1.execSync)(`launchctl load "${plistFile}"`, { stdio: 'pipe', timeout: 10000, windowsHide: true });
